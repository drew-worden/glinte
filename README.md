...
Glinte is an component library for Svelte, and comes out of the box with strong opinions on how user interfaces should be created. There are few principles that were kept in mind while Glinte was/is being developed.
